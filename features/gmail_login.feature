Feature: Gmail_login
	Scenario: Valid_gmail_login
		...
		And I enter "thisisfortestinginchicago@gmail.com" into input field having id "Email"
		...
		Then I wait for 5 sec
		And I enter "thisisfortestinginchicago@gmail.com" into input field having class "vO"
		Then I wait for 1 sec
		And I enter "This is Mike" into input field having class "aoT"
		Then I should send email
		Then I should go back to inbox
